...
// Images
import tokyoRainbowBridgeHero from "../assets/tokyoRainbowBridgeHero.png";
import tokyoTowerAerial from "../assets/tokyoTowerAerialImage.png";
import mtFuJiEscape from "../assets/mtFujiEscapeImage.png";
import hakoneSerenityImage from "../assets/hakoneSerenityImage.png";
import nikkoRedBridgeImage from "../assets/nikkoRedBridgeImage.png";
import kamakuraGreatBuddhaImage from "../assets/kamakuraGreatBuddhaImage.png";
import customTourImage from "../assets/customTourImage.png";
...
const benefits = [
  {
    ...
    description:
      "No crowded buses. Travel in comfort with dedicated luxury transport.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Deep cultural insights from expert local guides when desired.",
  },
  {
    title: "Expert Concierge Planning",
    description:
      "Pre-trip consultation ensures every detail aligns with your vision.",
  },
];
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              ...
              animation:
                "cinematicFloat 32s ease-in-out infinite alternate-reverse",
            }}
          ></div>
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 65% 45%, rgba(212, 175, 55, 0.2) 0%, rgba(255, 215, 0, 0.12) 35%, transparent 70%)",
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(120deg, transparent 20%, rgba(0, 191, 255, 0.12) 40%, rgba(255, 69, 0, 0.08) 50%, rgba(255, 215, 0, 0.15) 60%, transparent 80%)",
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(212, 175, 55, 0.15) 0%, rgba(0, 191, 255, 0.08) 30%, transparent 100%)",
        ...
        >
          <div className="max-w-4xl text-center">
            ...
            <div className="space-y-12 max-w-3xl mx-auto">
              ...
              >
                Curated one-day journeys that balance cultural depth, visual
                beauty, and seamless comfort — each experience, exclusively
                yours.
              </p>
            </div>
        ...
        >
          <div className="space-y-12">
            ...
            <div className="space-y-8 text-luxury-lg text-nippon-gray leading-relaxed font-sans max-w-3xl mx-auto">
              <p>
                At Nippon Imperial, our Private Day Tours are handpicked to give
                you a deeper sense of place — blending iconic highlights with
                hidden charm.
              </p>

              <p>
                Whether you seek temples, coastlines, mountain views, or city
                contrasts, every tour is guided by elegance, flexibility, and
        ...
        <div className="relative z-10 max-w-7xl mx-auto content-padding">
          ...
          <div className="text-center space-y-8 mb-16" data-scroll-reveal>
            ...
            <p className="text-luxury-xl text-nippon-gray-light font-sans leading-relaxed max-w-2xl mx-auto">
              Six carefully curated journeys — each offering a distinct
              perspective on Japan's beauty and culture.
            </p>
          </div>
                  ...
                  <div className="absolute inset-0 bg-nippon-black/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center p-6">
                    <div className="text-center space-y-4">
                      ...
                      <div className="flex items-center justify-center space-x-2 text-nippon-gold">
                        <span className="text-luxury-sm font-sans tracking-wider">
                          Click to Learn More
                        </span>
          ...
          <div className="space-y-16">
            <div className="text-center">
              ...
              <p className="text-luxury-lg text-nippon-gray font-sans leading-relaxed max-w-2xl mx-auto">
                No crowded buses. No fixed routes. Just meaningful travel — at
                your pace.
              </p>
            </div>
        ...
        >
          <div className="space-y-12">
            <div className="space-y-8">
              ...
              <p className="text-luxury-xl text-nippon-gray-light font-sans leading-relaxed max-w-2xl mx-auto">
                Not sure which destination is right for you? Tell us your
                interests and travel dates — our concierge team will match you
