...
import hakoneCheckpointImage from "../assets/image5.png";
import hakoneShrineImage from "../assets/image4.png";
import gotembaOutletsImage from "../assets/image6.png";
import hakoneRopewayImage from "../assets/image3.png";
import hakoneOnsenImage from "../assets/image7.png";
import hakoneOpenAirImage from "../assets/image1.png";

export default function HakoneSerenity() {
  ...
  const itineraryHighlights = [
    {
      ...
      detailedDescription:
        "Immerse yourself in Japan's premier open-air art museum, where contemporary sculptures and installations blend harmoniously with the natural landscape. Walk through meticulously curated gardens featuring works by Henry Moore, Pablo Picasso, and renowned Japanese artists, all set against the dramatic backdrop of Hakone's mountains.",
      duration: "90 minutes",
      highlights: [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1726456357343-95137bd8a065?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxIYWtvbmUlMjBwaXJhdGUlMjBzaGlwJTIwbGFrZSUyMGNydWlzZXxlbnwxfHx8fDE3NTU2NzExMDZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
    {
      icon: Cable,
    ...
    },
    {
      ...
      detailedDescription:
        "Conclude your Hakone journey with the ultimate relaxation experience at a traditional hot spring. Soak in mineral-rich thermal waters while surrounded by natural beauty, allowing the therapeutic properties to rejuvenate both body and spirit. This optional addition provides the perfect ending to your cultural and scenic adventure.",
      duration: "90 minutes",
      highlights: [
