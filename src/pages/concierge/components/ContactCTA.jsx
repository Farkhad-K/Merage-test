...
const contactMethods = [
  {
    ...
    description:
      "Schedule a private conversation with one of our Japan Cultural Specialists to discuss your dreams and desires.",
  ...
  },
  {
    ...
    description:
      "Share your vision, timeline, and preferences. We respond within 4 hours with thoughtful recommendations.",
    action: "Send Inquiry",
  ...
  },
  {
    ...
    description:
      "Speak directly with our Tokyo-based concierge team for urgent requests or real-time assistance.",
    action: "Call Now",
  ...
  return (
    <section id="contact" className="relative bg-nippon-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-nippon-gold opacity-3 blur-3xl"
          style={{ animation: "luxuryPulse 25s ease-in-out infinite" }}
        ></div>
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-nippon-gold opacity-2 blur-3xl"
          style={{ animation: "luxuryPulse 30s ease-in-out infinite reverse" }}
        ></div>
      </div>
          ...
          <div className="text-center space-y-12 mb-20" data-scroll-reveal>
            <div className="space-y-8">
              ...
              <p className="text-luxury-xl text-nippon-gray-light font-sans leading-relaxed max-w-3xl mx-auto">
                Three pathways to begin your imperial journey—each designed to
          ...
          <div className="text-center space-y-8" data-scroll-reveal>
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="space-y-2">
                <div className="flex items-center justify-center space-x-2 text-nippon-gold">
                  ...
                  <span className="font-sans text-luxury-sm uppercase tracking-wider">
                    Email
                  </span>
                </div>
            ...
            <div className="mt-16 max-w-3xl mx-auto">
              <p className="text-luxury-xl text-nippon-gray-light font-serif italic leading-relaxed">
                "In Japan, we believe that every meeting is a treasure. We look
                forward to the treasure of meeting you."
              </p>
